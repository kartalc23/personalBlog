                                            ...
                                            foreach ($yorumlar as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    if ( $value->yorum_onay==0) {
                                                        echo '<a href="index.php?url=yorum_onayla&id='. $value->yorum_id .'" class="btn btn-success" style="margin-right: 10px;">Onayla</a>';
                                                        echo '<a href="index.php?url=yorum_sil&id='. $value->yorum_id .'" class="btn btn-danger" onclick="return confirm("Silinecek Eminmisiniz ?");>Sil</a>';
